...
const GameScreenMultiplayer = ({ onBackToMenu, isHost, roomId }: GameScreenMultiplayerProps) => {
  ...
  return (
    ...
    <div className="min-h-screen w-full bg-background text-foreground font-press-start flex flex-col items-center justify-between p-8 relative select-none">
      ...
      {/* Player list panel */}
      {showPlayerList && (
        <div className="fixed top-28 right-20 w-64 flex-shrink-0 rounded-xl bg-gradient-to-b from-indigo-500 via-blue-600 to-blue-800 shadow-xl border-2 border-white/30 p-4 flex flex-col items-center h-[450px] z-30">
